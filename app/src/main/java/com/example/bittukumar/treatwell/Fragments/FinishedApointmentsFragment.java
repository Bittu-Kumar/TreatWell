...
public class FinishedApointmentsFragment extends Fragment {
    private RecyclerView recyclerView;
    private FRecycler_View_Adapter adapter;
    List<FData> data;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_finished_apointments, container, false);
    ...
    public void onStart() {
        super.onStart();
        data = new ArrayList<>();
        recyclerView = (RecyclerView)getActivity().findViewById(R.id.finishedRecyclerView);
    ...
    private void getAppointmentData() {
        ...
        VolleyStringRequest.request(getActivity(), AppConstants.finishedAppUrl,params,getAppDataResp);
    }
    ...
    VolleyStringRequest.OnStringResponse getAppDataResp = new VolleyStringRequest.OnStringResponse() {
        ...
        public void responseReceived(String response) {
            ...
            adapter =new FRecycler_View_Adapter(data,getActivity());
    ...
    private List<FData> setData(String response) {
        List<FData> localData = new ArrayList<>();
        try {
            ...
            for (int i = 0;i<jsonArray.length();i++)
            {
                ...
                localData.add(new FData(doc_name,doc_spec,hosp_name,hosp_addr,fee,date,starttime,endtime));
            }
